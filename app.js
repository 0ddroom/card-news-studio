...
function fillSampleStory() {
  ...
  $("#summary").value =
    "고객가치 혁신 성과와 의미 있는 시도들을 서로 공유하고 응원과 칭찬을 보낼 수 있도록 <성공로그> 운영을 시작했습니다. 각 본부/실의 많은 도움과 지원 끝에 운영을 시작할 수 있었는데요. 특히 모두가 사례 공유를 적극적으로 해 주신 덕분에 직원분들이 타 본부/실에서 어떤 일들을 하고 계신지 잘 알 수 있는 기회가 되었다고 생각합니다. 이 자리를 빌어 감사의 말씀을 전합니다. (후략)";
  $("#impactMetric").value = "월 1회 정기 공유 예정";
  $("#evidence").value =
    "댓글에 직원분들이 서로 남겨 주신 따뜻한 응원과 칭찬의 말들을 보며 보람을 느꼈습니다.";
  $("#quote").value = "좋은 성과와 시도가 조직 안에서 더 자주 알려졌으면 합니다.";
  $("#desiredMessage").value = "우리의 성과를 공유하고, 기록하며 더 큰 고객 가치로 연결합니다.";
